...
{
public:
	vertex()	: m_Pnt(0.0F, 0.0F), identifier(0)  {}
	vertex(const vertex& v)   : m_Pnt(v.m_Pnt), identifier(v.identifier)		{}
	vertex(const PointF& pnt, int id=0) : m_Pnt(pnt), identifier(id)           {}
	vertex(REAL x, REAL y, int id=0) : m_Pnt(x, y), identifier(id) {}
	vertex(int x, int y, int id=0)	 : m_Pnt((REAL) x, (REAL) y), identifier(id)    {}
